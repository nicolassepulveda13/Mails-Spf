    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (abrir.ShowDialog() == DialogResult.OK)
            {
                ...
                {
                    #region ACTIVAD
                OleDbConnection Conexion = new OleDbConnection(@"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\Users\nsepulveda\Downloads\SPF-Mails-master\Mail.mdb;");
                    Conexion.Open();
                    string Query = "";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (abrir.ShowDialog() == DialogResult.OK)
            {
                ...
                for (int i = 0; DT.Rows.Count > i; i++)
                {
                    int contadoradj = 0;
                    //string lala = Convert.ToString(DT.Rows[i]["MAIL"]);
                    string maildestin = Convert.ToString(DT.Rows[i]["mails"]);
                    //string maildestin = "nico_xeneise93@hotmail.com";
                    string IDe = DT.Rows[i]["Unidad"].ToString();
                    //string maildestin = "economatocp1@yahoo.com.ar";
                    MailMessage email = new MailMessage();
                    email.To.Add(new MailAddress(maildestin));
                    email.From = new MailAddress("spf_actividad@hotmail.com");
                ...
                "Liquidaciones de Haberes. ";
                    ...
                    string directorio = (abrir.SelectedPath + @"\" + IDe + ".xls");
